...
export const APP_TRANSLATIONS = {
  ...
  "es-ES": {
    ...
    controls: {
      ...
      vibration: "Vibracion",
      vibrationOn: "Vibracion Activada",
      vibrationOff: "Vibracion Desactivada",
  ...
  "pt-PT": {
    ...
    controls: {
      ...
      vibration: "Vibracao",
      vibrationOn: "Vibracao Ligada",
      vibrationOff: "Vibracao Desligada",
      enterEditMode: "Editar",
